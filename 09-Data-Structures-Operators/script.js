...
// playesrs2 =  ['Burki', 'Schulz', 'Hummels', 'Akanji', 'Hakimi', 'Weigl', 'Witsel', 'Hazard', 'Brandt', 'Sancho', 'Gotze']

//2)
const [gk, ...fieldPlayers] = game.players[0];
// gk = Neuer , fieldPlayers = ['Pavard', 'Martinez', 'Alaba', 'Davies', 'Kimmich', 'Goretzka', 'Coman', 'Muller', 'Gnarby', 'Lewandowski']

// 3)
const allPlayers = [...game.players[0], ...game.players[1]];
// allPlayers willl contain players1+players2
...
// team1 = 1.33  draw = 3.25  team2 = 6.5
...
// console.log(restaurant.openingHours.mon.open); //it will give us a error
